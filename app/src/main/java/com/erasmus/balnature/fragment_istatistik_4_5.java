...
public class fragment_istatistik_4_5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View ff = inflater.inflate(R.layout.fragment_istatistik_4_5, container, false);
                ...
                databaseRef4.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            ...
                            kagıatık = value.kağıta;camatık2 += value.cama;
                            ...
                            entries1.add(new Entry(sayi, metalatıkg));
                            entries2.add(new Entry(sayi, kagıatık));
                            sayi += 1;
                        }
                        txt.setText(String.valueOf(metalatık2+" kg"));
                        txt2.setText(String.valueOf(metalatıkg2+" kg"));
