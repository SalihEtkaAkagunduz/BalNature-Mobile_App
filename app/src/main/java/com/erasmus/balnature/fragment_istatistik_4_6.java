...
public class fragment_istatistik_4_6 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View ff = inflater.inflate(R.layout.fragment_istatistik_4_6, container, false);
                ...
                databaseRef4.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            ...
                            entries1.add(new Entry(sayi, camatıkg));
                            entries2.add(new Entry(sayi, camatık));
                            sayi += 1;
                        }
                        txt.setText(String.valueOf(camatık2+" kg"));
                        txt2.setText(String.valueOf(camatıkg2+" kg"));
