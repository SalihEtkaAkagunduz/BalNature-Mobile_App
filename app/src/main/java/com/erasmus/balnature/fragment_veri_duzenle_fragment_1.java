...
public class fragment_veri_duzenle_fragment_1 extends Fragment {
    Button btn;
    RecyclerView rv;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View ff = inflater.inflate(R.layout.fragment_veri_duzenle_fragment_1, container, false);
        return ff;
    }
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            databaseRef4.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    adptr = new adapter_2(requireContext(), data, ortalama, navController, id);
