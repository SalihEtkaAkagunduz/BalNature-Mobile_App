...
public class anamenu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        frglist.clear();
        rttt.clear();
        frglist.add(new fragment_menuu());
        frglist.add(new fragment_haber());
        frglist.add(new fragment_veri());
        view = inflater.inflate(R.layout.fragment_anamenu, container, false);
        ...
        tabLayout.getTabAt(1).setIcon(R.drawable.haberdolu);
        tabLayout.getTabAt(2).setIcon(R.drawable.outline_school_24);
        ...
        if (selected) {
            switch (tab.getPosition()) {
                case 0:
                    ...
                    break;
                case 1:
                    icon = ContextCompat.getDrawable(requireContext(), R.drawable.haberdolu);
                    renk = R.color.tablayouttiklandi;
                    break;
                case 2:
                    icon = ContextCompat.getDrawable(requireContext(), R.drawable.baseline_school_24);
                    renk = R.color.tablayouttiklandi;
                    break;
                default:
                    icon = null;
            ...
            switch (tab.getPosition()) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    icon = ContextCompat.getDrawable(requireContext(), R.drawable.outline_school_24);
                    renk = R.color.white;
                    break;
                default:
                    icon = null;
