...
public class fragment_ayarlar_sifre2 extends Fragment {
...
TextView txt;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View ff= inflater.inflate(R.layout.fragment_ayarlar_sifre2, container, false);
        patternLockView=ff.findViewById(R.id.patternLockView);
        FirebaseAuth mAuth = FirebaseAuth.getInstance();
        FirebaseUser currentUser = mAuth.getCurrentUser();
        img=ff.findViewById(R.id.imageView70);
txt=ff.findViewById(R.id.textView177);

btn=ff.findViewById(R.id.button19);
btn.setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View view) {
        Navigation.findNavController(ff).navigate(R.id.fragment_ayarlar_ana);
    }
});
        if (currentUser != null) {
            ...
            patternLockView.setOnPatternListener(new PatternLockView.OnPatternListener() {
                ...
                public boolean onComplete(ArrayList<Integer> ids) {
                    ...
                    String veri =  getArguments().getString("veri");

                    if(result.equals(veri)){
                        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(getContext());
                        SharedPreferences.Editor editor = sharedPreferences.edit();
                        editor.putString("sifre", result);
                        editor.apply();

                        SharedPreferences sharedPreferences2 = PreferenceManager.getDefaultSharedPreferences(getContext());
                        SharedPreferences.Editor editor2 = sharedPreferences.edit();
                        editor.putInt("sifrekontrol", 1);
                        editor.apply();
                        Navigation.findNavController(ff).navigate(R.id.action_fragment_ayarlar_sifre22_to_fragment_ayarlar_ana3);
