...
public class fragment_veri_incele_fragment_11 extends Fragment {
    Button btn;
    RecyclerView rv;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View ff = inflater.inflate(R.layout.fragment_veri_incele_fragment_11, container, false);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                databaseRef4.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        // getContext() veya getActivity() metotlarından hangisi doluysa onu kullanın
                        // Her ikisi de null değilse getContext() tercih edilir.
                        ...
                        if (context != null) {
                            adptr = new adapter_4(context, data, ortalama, navController);
